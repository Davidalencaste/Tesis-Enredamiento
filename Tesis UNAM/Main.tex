...
% Suprime mensajes Underfull/Overfull hbox
\hbadness=10000
\hfuzz=50pt
...
\usepackage{mathtools} %para el \coloneqq
...
\title{Caracterización Geométrica del Enredamiento Cuántico}
...
\logouni{Escudo-UNAM-v15} % nombre del archivo del escudo de la universidad
\logofac{Escudo-FCIENCIAS-v15} % nombre del archivo del escudo de la facultad
...
\emph{``It's the questions we can't answer that teach us the most...''}
...
%\chapter{Teoría cuántica en la teoría de la información}
%\subfile{capitulos/teoria_cuantica_info}
